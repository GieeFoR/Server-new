...
new const String:PLUGIN_NAME[32] = "coditem_kamizelkakuloodporna";
new const String:PLUGIN_AUTHOR[32] = "GieeF";
new const String:PLUGIN_VERSION[32] = "1.0";
new const String:PLUGIN_DESCRIPTION[64] = "Item COD - Kamizelka Kuloodporna";
new const String:PLUGIN_URL[32] = "-";

new const String:item_name[] = "Kamizelka Kuloodporna";
new const String:item_description[] = "Dostajesz 30 punktów wytrzymałości";
...
public OnAllPluginsLoaded() {
	CreateTimer(1.1, RegisterStart, 0);
}
