...
new const String:PLUGIN_NAME[32] = "coditem_pancerzneomexowy";
new const String:PLUGIN_AUTHOR[32] = "GieeF";
new const String:PLUGIN_VERSION[32] = "1.0";
new const String:PLUGIN_DESCRIPTION[64] = "Item COD - Pancerz Neomexowy";
new const String:PLUGIN_URL[32] = "-";

new const String:item_name[] = "Pancerz Neomexowy";
new const String:item_description[] = "Posiadasz 1/RNG szans na odbicie zadanych obrażeń";
...
public OnAllPluginsLoaded() {
	CreateTimer(2.3, RegisterStart, 0);
}
...
public Action:OnPlayerTakeDamage(client, &attacker, &inflictor, &Float:damage, &damagetype) {
	...
	if(GetRandomInt(1, player_itemValue[client]) == 1) {
		SDKHooks_TakeDamage(attacker, client, client, damage, DMG_GENERIC);
