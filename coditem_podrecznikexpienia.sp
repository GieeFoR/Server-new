...
new const String:PLUGIN_NAME[32] = "coditem_podrecznikexpienia";
new const String:PLUGIN_AUTHOR[32] = "GieeF";
new const String:PLUGIN_VERSION[32] = "1.0";
new const String:PLUGIN_DESCRIPTION[64] = "Item COD - Podręcznik Expienia";
new const String:PLUGIN_URL[32] = "-";

new const String:item_name[] = "Podręcznik Expienia";
new const String:item_description[] = "Zdobywasz o 50% więcej expa";
...
public OnAllPluginsLoaded() {
	CreateTimer(2.6, RegisterStart, 0);
}
