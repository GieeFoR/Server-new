...
new const String:PLUGIN_NAME[32] = "coditem_porazajacenaboje";
new const String:PLUGIN_AUTHOR[32] = "GieeF";
new const String:PLUGIN_VERSION[32] = "1.0";
new const String:PLUGIN_DESCRIPTION[64] = "Item COD - Porażające Naboje";
new const String:PLUGIN_URL[32] = "-";

new const String:item_name[] = "Porażające Naboje";
new const String:item_description[] = "Posiadasz 1/RNG szans na wyrzucenie broni przeciwnika";
...
public OnAllPluginsLoaded() {
	CreateTimer(2.8, RegisterStart, 0);
}
...
public Action:OnPlayerTakeDamage(client, &attacker, &inflictor, &Float:damage, &damagetype) {
	...
	if(GetRandomInt(1, player_itemValue[attacker]) == 1) {
		ClientCommand(client, "drop");				//to moze nie dzialac, ale cos sie poradzi
	}
