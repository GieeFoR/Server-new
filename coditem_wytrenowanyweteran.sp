...
new const String:PLUGIN_NAME[32] = "coditem_wytrenowanyweteran";
new const String:PLUGIN_AUTHOR[32] = "GieeF";
new const String:PLUGIN_VERSION[32] = "1.0";
new const String:PLUGIN_DESCRIPTION[64] = "Item COD - Wytrenowany Weteran";
new const String:PLUGIN_URL[32] = "-";

new const String:item_name[] = "Wytrenowany Weteran";
new const String:item_description[] = "Dostajesz 100HP oraz tracisz 30 punktów kondycji";
new const String:item_weapons[] = "";
new const String:item_blackList[] = "";
new const item_intelligence = 0;
new const item_health = 100;
...
public OnAllPluginsLoaded() {
	CreateTimer(4.0, RegisterStart, 0);
}
